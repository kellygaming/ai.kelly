...
export default function ImageStudio() {
  ...
  async function downloadImage() {
    ...
    try {
      ...
      a.href = url;
      a.download = `kellyia-miniature-${Date.now()}.jpg`;
      document.body.appendChild(a);
      a.click();
      a.remove();
      URL.revokeObjectURL(url);
    } catch {
      // Repli si le téléchargement direct échoue (ex: CORS) : on ouvre
      // l'image dans un nouvel onglet, l'utilisateur peut faire "Enregistrer sous".
      ...
      <div className={`studio-result ${format === "tiktok" ? "fmt-tiktok" : "fmt-youtube"}`}>
        ...
        {status === "done" && resultUrl && (
          <div className="studio-image-result">
            ...
            <button type="button" className="studio-download-btn" onClick={downloadImage}>
